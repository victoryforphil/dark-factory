...
- Source page: /docs/stable/core_extensions/httpfs/overview.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, core extensions, httpfs, overview html
- Summary: Search Shortcut cmd + k | ctrl + k
----

Source: https://duckdb.org/docs/stable/core_extensions/httpfs/overview.html
...
For plain HTTP(S), only file reading is supported. For object storage using the S3 API, the `httpfs` extension supports reading/writing/[globbing](/docs/stable/sql/functions/pattern_matching.html#globbing) files.
...
The `httpfs` extension supports connecting to [HTTP(S) endpoints](/docs/stable/core_extensions/httpfs/https.html).

## [S3 API](#s3-api)

The `httpfs` extension supports connecting to [S3 API endpoints](/docs/stable/core_extensions/httpfs/s3api.html).

## Pages in This Section

##### About this page

							- [See the repository of this feature on GitHub](https://github.com/duckdb/duckdb-httpfs)

							- [Report content issue](https://github.com/duckdb/duckdb-web/issues/new?title=Issue%20found%20on%20page%20'httpfs%20Extension%20for%20HTTP%20and%20S3%20Support'&labels=issue%20found%20on%20page&body=%0A%3E%20Please%20describe%20the%20problem%20you%20encountered%20in%20the%20DuckDB%20documentation%20and%20include%20the%20%22Page%20URL%22%20link%20shown%20below.%0A%3E%20Note:%20only%20create%20an%20issue%20if%20you%20wish%20to%20report%20a%20problem%20with%20the%20DuckDB%20documentation.%20For%20questions%20about%20DuckDB%20or%20the%20use%20of%20certain%20DuckDB%20features,%20use%20[GitHub%20Discussions](https://github.com/duckdb/duckdb/discussions/),%20[Stack%20Overflow](https://stackoverflow.com/questions/tagged/duckdb),%20or%20[Discord](https://discord.duckdb.org/).%0A%0APage%20URL:%20%3Chttps://duckdb.org/docs/stable/core_extensions/httpfs/overview.html%3E%0A)

							- [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/core_extensions/httpfs/overview.md)

							- [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/core_extensions/httpfs/overview.md)
