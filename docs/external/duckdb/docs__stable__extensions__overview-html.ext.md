...
- Source page: /docs/stable/extensions/overview.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, extensions, overview html
- Summary: Search Shortcut cmd + k | ctrl + k
----

Source: https://duckdb.org/docs/stable/extensions/overview.html
...
The list includes most, but not all, available core extensions. For the full list, we maintain a [list of core extensions](/docs/stable/core_extensions/overview.html).
...
For example, to use the built-in [`json` extension](/docs/stable/data/json/overview.html) to read a JSON file:
...
To make the DuckDB distribution lightweight, only a few essential extensions are built-in, varying slightly per distribution. Which extension is built-in on which platform is documented in the [list of core extensions](/docs/stable/core_extensions/overview.html#default-extensions).

## [Installing More Extensions](#installing-more-extensions)
...
Extension installation and loading are subject to a few [limitations](/docs/stable/extensions/installing_extensions.html#limitations).
...
### [Explicit `INSTALL` and `LOAD`](#explicit-install-and-load)
...
to install and load the [`spatial` extension](/docs/stable/core_extensions/spatial/overview.html), run:
...
This repository can either be an alias, such as [`community`](/community_extensions/), or it can be a direct URL, provided as a single-quoted string.
...
### [Autoloading Extensions](#autoloading-extensions)
...
DuckDB will automatically install and load the [`httpfs`](/docs/stable/core_extensions/httpfs/overview.html) extension. No explicit `INSTALL` or `LOAD` statements are required.
...
To see which extensions can be autoloaded, check the [core extensions list](/docs/stable/core_extensions/overview.html).

### [Community Extensions](#community-extensions)

DuckDB supports installing third-party [community extensions](/community_extensions/). For example, you can install the [`avro` community extension](/community_extensions/extensions/avro.html) via:

```
INSTALL avro FROM community;
```

Community extensions are contributed by community members but they are built, [signed](/docs/stable/extensions/extension_distribution.html#signed-extensions), and distributed in a centralized repository.
...
For more details on extension version refer to the [Extension Versioning page](/docs/stable/extensions/versioning_of_extensions.html).
...
See the [installation instructions](/docs/stable/extensions/installing_extensions.html) and the [advanced installation methods page](/docs/stable/extensions/advanced_installation_methods.html).

## Pages in This Section

##### About this page

							- [Report content issue](https://github.com/duckdb/duckdb-web/issues/new?title=Issue%20found%20on%20page%20'Extensions'&labels=issue%20found%20on%20page&body=%0A%3E%20Please%20describe%20the%20problem%20you%20encountered%20in%20the%20DuckDB%20documentation%20and%20include%20the%20%22Page%20URL%22%20link%20shown%20below.%0A%3E%20Note:%20only%20create%20an%20issue%20if%20you%20wish%20to%20report%20a%20problem%20with%20the%20DuckDB%20documentation.%20For%20questions%20about%20DuckDB%20or%20the%20use%20of%20certain%20DuckDB%20features,%20use%20[GitHub%20Discussions](https://github.com/duckdb/duckdb/discussions/),%20[Stack%20Overflow](https://stackoverflow.com/questions/tagged/duckdb),%20or%20[Discord](https://discord.duckdb.org/).%0A%0APage%20URL:%20%3Chttps://duckdb.org/docs/stable/extensions/overview.html%3E%0A)

							- [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/extensions/overview.md)

							- [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/extensions/overview.md)
...
- [Installing More Extensions](#installing-more-extensions) [Explicit INSTALL and LOAD](#explicit-install-and-load)
