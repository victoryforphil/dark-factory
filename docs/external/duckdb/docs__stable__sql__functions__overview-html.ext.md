...
- Source page: /docs/stable/sql/functions/overview.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, sql, functions, overview html
- Summary: Search Shortcut cmd + k | ctrl + k
----

Source: https://duckdb.org/docs/stable/sql/functions/overview.html
...
## [Function Chaining via the Dot Operator](#function-chaining-via-the-dot-operator)

DuckDB supports the dot syntax for function chaining. This allows the function call `fn(arg1, arg2, arg3, ...)` to be rewritten as `arg1.fn(arg2, arg3, ...)`. For example, take the following use of the [`replace` function](/docs/stable/sql/functions/text.html#replacestring-source-target):
...
### [Using with Literals and Arrays](#using-with-literals-and-arrays)
...
##### About this page
							...
							- [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/sql/functions/overview.md)

							- [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/sql/functions/overview.md)
...
- [Function Chaining via the Dot Operator](#function-chaining-via-the-dot-operator) [Using with Literals and Arrays](#using-with-literals-and-arrays)
