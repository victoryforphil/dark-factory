...
- Source page: /docs/stable/clients/rust.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, clients, rust html
- Summary: [![Image 1: DuckDB Logo for Download](http://duckdb.org/images/logo-dl/DuckDB_Logo-horizontal.svg)](https://duckdb.org/)
----

Source: https://duckdb.org/docs/stable/clients/rust.html
...
*   [1.5-dev"](http://duckdb.org/docs/preview/clients/rust)
*   [1.4](http://duckdb.org/docs/stable/clients/rust)
*   [1.3](http://duckdb.org/docs/1.3/clients/rust)
*   [1.2](http://duckdb.org/docs/1.2/clients/rust)
...
> The latest stable version of the DuckDB Rust client is 1.4.4.

[Installation](http://duckdb.org/docs/stable/clients/rust.html#installation)
----------------------------------------------------------------------------
...
[Basic API Usage](http://duckdb.org/docs/stable/clients/rust.html#basic-api-usage)
----------------------------------------------------------------------------------
...
### [Startup & Shutdown](http://duckdb.org/docs/stable/clients/rust.html#startup--shutdown)

To use duckdb, you must first initialize a 
```plaintext
Connection
```
 handle using 
...
.duckdb
```
, or anything else). You can also use 
```plaintext
...
Connection
```
 will automatically close the underlying db connection for you when it goes out of scope (via 
```plaintext
Drop
```
). You can also explicitly close the 
```plaintext
Connection
```
 with 
...
### [Querying](http://duckdb.org/docs/stable/clients/rust.html#querying)

SQL queries can be sent to DuckDB using the 
```plaintext
execute()
```
...
[Appender](http://duckdb.org/docs/stable/clients/rust.html#appender)
--------------------------------------------------------------------

The Rust client supports the [DuckDB Appender API](http://duckdb.org/docs/stable/data/appender.html) for bulk inserts. For example:
...
*   [See the repository of this feature on GitHub](https://github.com/duckdb/duckdb-rs)
*   [Report content issue](https://github.com/duckdb/duckdb-web/issues/new?title=Issue%20found%20on%20page%20%27Rust%20Client%27&labels=issue%20found%20on%20page&body=%0A%3E%20Please%20describe%20the%20problem%20you%20encountered%20in%20the%20DuckDB%20documentation%20and%20include%20the%20%22Page%20URL%22%20link%20shown%20below.%0A%3E%20Note:%20only%20create%20an%20issue%20if%20you%20wish%20to%20report%20a%20problem%20with%20the%20DuckDB%20documentation.%20For%20questions%20about%20DuckDB%20or%20the%20use%20of%20certain%20DuckDB%20features,%20use%20[GitHub%20Discussions](https://github.com/duckdb/duckdb/discussions/),%20[Stack%20Overflow](https://stackoverflow.com/questions/tagged/duckdb),%20or%20[Discord](https://discord.duckdb.org/).%0A%0APage%20URL:%20%3Chttps://duckdb.org/docs/stable/clients/rust.html%3E%0A "Create GitHub issue")
*   [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/clients/rust.md "See Markdown")
*   [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/clients/rust.md "Go to GitHub")
