...
- Source page: /docs/stable/core_extensions/overview.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, core extensions, overview html
- Summary: Search Shortcut cmd + k | ctrl + k
----

Source: https://duckdb.org/docs/stable/core_extensions/overview.html
...
## [List of Core Extensions](#list-of-core-extensions)
  ...
  Name
      ...
      [autocomplete](/docs/stable/core_extensions/autocomplete.html)
      Adds support for autocomplete in the shell
      DuckDB team
      Secondary

      [avro](/docs/stable/core_extensions/avro.html)
      Add support for reading Avro files
      DuckDB team
      Secondary

      [aws](/docs/stable/core_extensions/aws.html)
      Provides features that depend on the AWS SDK
      DuckDB team
      Secondary

      [azure](/docs/stable/core_extensions/azure.html)
      Adds a filesystem abstraction for Azure blob storage to DuckDB
      DuckDB team
      Secondary

      [delta](/docs/stable/core_extensions/delta.html)
      Adds support for Delta Lake
      DuckDB team
      Secondary

      [ducklake](/docs/stable/core_extensions/ducklake.html)
      Adds support for DuckLake
      DuckDB team
      Secondary

      [encodings](/docs/stable/core_extensions/encodings.html)
      Adds support for encodings available in the ICU data repository
      DuckDB team
      Secondary

      [excel](/docs/stable/core_extensions/excel.html)
      Adds support for reading and writing Excel files
      DuckDB team
      Secondary

      [fts](/docs/stable/core_extensions/full_text_search.html)
      Adds support for full-text search indexes
      DuckDB team
      Secondary

      [httpfs](/docs/stable/core_extensions/httpfs/overview.html)
      Adds support for reading/writing files over an HTTP(S) or S3 connection
      DuckDB team
      Primary
      http, https, s3

      [iceberg](/docs/stable/core_extensions/iceberg/overview.html)
      Adds support for Apache Iceberg
      DuckDB team
      Secondary

      [icu](/docs/stable/core_extensions/icu.html)
      Adds support for time zones and collations using the ICU library
      DuckDB team
      Primary

      [inet](/docs/stable/core_extensions/inet.html)
      Adds support for IP-related data types and functions
      DuckDB team
      Secondary

      [jemalloc](/docs/stable/core_extensions/jemalloc.html)
      Overwrites the system allocator with jemalloc
      DuckDB team
      Secondary

      [json](/docs/stable/data/json/overview.html)
      Adds support for JSON operations
      DuckDB team
      Primary

      [motherduck](/docs/stable/core_extensions/motherduck.html)
      Allows connecting to MotherDuck
      Third party

      md

      [mysql](/docs/stable/core_extensions/mysql.html)
      Adds support for reading from and writing to a MySQL database
      DuckDB team
      Secondary
      mysql_scanner

      [parquet](/docs/stable/data/parquet/overview.html)
      Adds support for reading and writing Parquet files
      DuckDB team
      Primary

      [postgres](/docs/stable/core_extensions/postgres.html)
      Adds support for reading from and writing to a PostgreSQL database
      DuckDB team
      Secondary
      postgres_scanner

      [spatial](/docs/stable/core_extensions/spatial/overview.html)
      Adds support for working with geospatial data and functions
      DuckDB team
      Secondary

      [sqlite](/docs/stable/core_extensions/sqlite.html)
      Adds support for reading from and writing to SQLite database files
      DuckDB team
      Secondary
      sqlite_scanner, sqlite3

      [tpcds](/docs/stable/core_extensions/tpcds.html)
      Adds TPC-DS data generation and query support
      DuckDB team
      Secondary

      [tpch](/docs/stable/core_extensions/tpch.html)
      Adds TPC-H data generation and query support
      DuckDB team
      Secondary

      [unity_catalog](/docs/stable/core_extensions/unity_catalog.html)
      Adds support for connecting to Unity Catalog
      DuckDB team
      Secondary
      uc_catalog

      [ui](/docs/stable/core_extensions/ui.html)
      Adds local UI for DuckDB
      Third party

      [vortex](/docs/stable/core_extensions/vortex.html)
      Adds support for reading and writing Vortex files
      Third party

      [vss](/docs/stable/core_extensions/vss.html)
      Adds support for vector similarity search queries
      DuckDB team
      Secondary
...
Primary extension are covered by [community support](https://duckdblabs.com/community_support_policy/).
Secondary extensions are supported on a best-effort basis. That said, they still receive frequent bugfixes/updates and are shipped with new DuckDB releases.

## Pages in This Section

##### About this page

							- [Report content issue](https://github.com/duckdb/duckdb-web/issues/new?title=Issue%20found%20on%20page%20'Core%20Extensions'&labels=issue%20found%20on%20page&body=%0A%3E%20Please%20describe%20the%20problem%20you%20encountered%20in%20the%20DuckDB%20documentation%20and%20include%20the%20%22Page%20URL%22%20link%20shown%20below.%0A%3E%20Note:%20only%20create%20an%20issue%20if%20you%20wish%20to%20report%20a%20problem%20with%20the%20DuckDB%20documentation.%20For%20questions%20about%20DuckDB%20or%20the%20use%20of%20certain%20DuckDB%20features,%20use%20[GitHub%20Discussions](https://github.com/duckdb/duckdb/discussions/),%20[Stack%20Overflow](https://stackoverflow.com/questions/tagged/duckdb),%20or%20[Discord](https://discord.duckdb.org/).%0A%0APage%20URL:%20%3Chttps://duckdb.org/docs/stable/core_extensions/overview.html%3E%0A)

							- [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/core_extensions/overview.md)

							- [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/core_extensions/overview.md)
