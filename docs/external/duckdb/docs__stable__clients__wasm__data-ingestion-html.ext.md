...
- Source page: /docs/stable/clients/wasm/data_ingestion.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, clients, wasm, data ingestion html
- Summary: [![Image 1: DuckDB Logo for Download](http://duckdb.org/images/logo-dl/DuckDB_Logo-horizontal.svg)](https://duckdb.org/)
----

Source: https://duckdb.org/docs/stable/clients/wasm/data_ingestion.html
...
*   [1.5-dev"](http://duckdb.org/docs/preview/clients/wasm/data_ingestion)
*   [1.4](http://duckdb.org/docs/stable/clients/wasm/data_ingestion)
*   [1.3](http://duckdb.org/docs/1.3/clients/wasm/data_ingestion)
*   [1.2](http://duckdb.org/docs/1.2/clients/wasm/data_ingestion)
...
Then, the data file is imported into DuckDB using insert functions ([insertArrowFromIPCStream](https://shell.duckdb.org/docs/classes/index.AsyncDuckDBConnection.html#insertArrowFromIPCStream), [insertArrowTable](https://shell.duckdb.org/docs/classes/index.AsyncDuckDBConnection.html#insertArrowTable), [insertCSVFromPath](https://shell.duckdb.org/docs/classes/index.AsyncDuckDBConnection.html#insertCSVFromPath), [insertJSONFromPath](https://shell.duckdb.org/docs/classes/index.AsyncDuckDBConnection.html#insertJSONFromPath)) or directly using FROM SQL query (using extensions like Parquet or [Wasm-flavored httpfs](http://duckdb.org/docs/stable/clients/wasm/data_ingestion.html#httpfs-wasm-flavored)).

[Insert statements](http://duckdb.org/docs/stable/data/insert.html) can also be used to import data.

[Data Import](http://duckdb.org/docs/stable/clients/wasm/data_ingestion.html#data-import)
-----------------------------------------------------------------------------------------

### [Open & Close Connection](http://duckdb.org/docs/stable/clients/wasm/data_ingestion.html#open--close-connection)
...
### [Apache Arrow](http://duckdb.org/docs/stable/clients/wasm/data_ingestion.html#apache-arrow)
...
### [CSV](http://duckdb.org/docs/stable/clients/wasm/data_ingestion.html#csv)
...
### [JSON](http://duckdb.org/docs/stable/clients/wasm/data_ingestion.html#json)
...
### [Parquet](http://duckdb.org/docs/stable/clients/wasm/data_ingestion.html#parquet)
...
### [httpfs (Wasm-Flavored)](http://duckdb.org/docs/stable/clients/wasm/data_ingestion.html#httpfs-wasm-flavored)
...
### [Insert Statement](http://duckdb.org/docs/stable/clients/wasm/data_ingestion.html#insert-statement)
...
*   [Report content issue](https://github.com/duckdb/duckdb-web/issues/new?title=Issue%20found%20on%20page%20%27Data%20Ingestion%27&labels=issue%20found%20on%20page&body=%0A%3E%20Please%20describe%20the%20problem%20you%20encountered%20in%20the%20DuckDB%20documentation%20and%20include%20the%20%22Page%20URL%22%20link%20shown%20below.%0A%3E%20Note:%20only%20create%20an%20issue%20if%20you%20wish%20to%20report%20a%20problem%20with%20the%20DuckDB%20documentation.%20For%20questions%20about%20DuckDB%20or%20the%20use%20of%20certain%20DuckDB%20features,%20use%20[GitHub%20Discussions](https://github.com/duckdb/duckdb/discussions/),%20[Stack%20Overflow](https://stackoverflow.com/questions/tagged/duckdb),%20or%20[Discord](https://discord.duckdb.org/).%0A%0APage%20URL:%20%3Chttps://duckdb.org/docs/stable/clients/wasm/data_ingestion.html%3E%0A "Create GitHub issue")
*   [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/clients/wasm/data_ingestion.md "See Markdown")
*   [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/clients/wasm/data_ingestion.md "Go to GitHub")
