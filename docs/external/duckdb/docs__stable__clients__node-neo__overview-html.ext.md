...
[Features](http://duckdb.org/docs/stable/clients/node_neo/overview.html#features)
---------------------------------------------------------------------------------

### [Main Differences from](http://duckdb.org/docs/stable/clients/node_neo/overview.html#main-differences-from-duckdb-node)[duckdb-node](https://www.npmjs.com/package/duckdb)
...
*   Lossless & efficient support for values of all [DuckDB data types](https://duckdb.org/docs/stable/sql/data_types/overview.html).
*   Wraps [released DuckDB binaries](https://github.com/duckdb/duckdb/releases) instead of rebuilding DuckDB.
*   Built on [DuckDB's C API](https://duckdb.org/docs/stable/clients/c/overview.html); exposes more functionality.

### [Roadmap](http://duckdb.org/docs/stable/clients/node_neo/overview.html#roadmap)
...
See the [issues list on GitHub](https://github.com/duckdb/duckdb-node-neo/issues) for the most up-to-date roadmap.

### [Supported Platforms](http://duckdb.org/docs/stable/clients/node_neo/overview.html#supported-platforms)
...
[Examples](http://duckdb.org/docs/stable/clients/node_neo/overview.html#examples)
---------------------------------------------------------------------------------

### [Get Basic Information](http://duckdb.org/docs/stable/clients/node_neo/overview.html#get-basic-information)
...
### [Connect](http://duckdb.org/docs/stable/clients/node_neo/overview.html#connect)
...
### [Create Instance](http://duckdb.org/docs/stable/clients/node_neo/overview.html#create-instance)
...
Set [configuration options](https://duckdb.org/docs/stable/configuration/overview.html):
...
### [Connect to Instance](http://duckdb.org/docs/stable/clients/node_neo/overview.html#connect-to-instance)

```
const connection = await instance.connect();
```

### [Disconnect](http://duckdb.org/docs/stable/clients/node_neo/overview.html#disconnect)
...
### [Specifying Values](http://duckdb.org/docs/stable/clients/node_neo/overview.html#specifying-values)
...
### [Stream Results](http://duckdb.org/docs/stable/clients/node_neo/overview.html#stream-results)
...
### [Get Result Data](http://duckdb.org/docs/stable/clients/node_neo/overview.html#get-result-data)
...
### [Convert Result Data](http://duckdb.org/docs/stable/clients/node_neo/overview.html#convert-result-data)
...
### [Fetch Chunks](http://duckdb.org/docs/stable/clients/node_neo/overview.html#fetch-chunks)
...
### [Inspect Data Types](http://duckdb.org/docs/stable/clients/node_neo/overview.html#inspect-data-types)
...
### [Inspect Data Values](http://duckdb.org/docs/stable/clients/node_neo/overview.html#inspect-data-values)
...
### [Displaying Timezones](http://duckdb.org/docs/stable/clients/node_neo/overview.html#displaying-timezones)
...
### [Append To Table](http://duckdb.org/docs/stable/clients/node_neo/overview.html#append-to-table)
...
### [Append Data Chunk](http://duckdb.org/docs/stable/clients/node_neo/overview.html#append-data-chunk)
...
### [Control Evaluation of Tasks](http://duckdb.org/docs/stable/clients/node_neo/overview.html#control-evaluation-of-tasks)
