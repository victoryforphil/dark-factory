...
- Source page: /docs/stable/operations_manual/logging/overview.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, operations manual, logging, overview html
- Summary: Search Shortcut cmd + k | ctrl + k
----

Source: https://duckdb.org/docs/stable/operations_manual/logging/overview.html
...
### [Logging-Specific Types](#logging-specific-types)
...
### [List of Available Log Types](#list-of-available-log-types)
...
This is a (non-exhaustive) list of the available log types in DuckDB.
  ...
  Log Type
      ...
      `QueryLog`
      Logs which queries are executed in DuckDB
      No

      `FileSystem`
      Logs all FileSystem interaction with DuckDB's Filesystem
      Yes

      `HTTP`
      Logs all HTTP traffic from DuckDB's internal HTTP client
      Yes

## [Log Storages](#log-storages)
...
the following log storage types are implemented in core DuckDB.
  ...
  Log Storage
      ...
      `memory`
      (default) Log to an in-memory buffer

      `stdout`
      Log to the stdout of the current process (in CSV format)
...
### [Normalized vs. Denormalized Logging](#normalized-vs-denormalized-logging)
...
##### About this page
							...
							- [Report content issue](https://github.com/duckdb/duckdb-web/issues/new?title=Issue%20found%20on%20page%20'Logging'&labels=issue%20found%20on%20page&body=%0A%3E%20Please%20describe%20the%20problem%20you%20encountered%20in%20the%20DuckDB%20documentation%20and%20include%20the%20%22Page%20URL%22%20link%20shown%20below.%0A%3E%20Note:%20only%20create%20an%20issue%20if%20you%20wish%20to%20report%20a%20problem%20with%20the%20DuckDB%20documentation.%20For%20questions%20about%20DuckDB%20or%20the%20use%20of%20certain%20DuckDB%20features,%20use%20[GitHub%20Discussions](https://github.com/duckdb/duckdb/discussions/),%20[Stack%20Overflow](https://stackoverflow.com/questions/tagged/duckdb),%20or%20[Discord](https://discord.duckdb.org/).%0A%0APage%20URL:%20%3Chttps://duckdb.org/docs/stable/operations_manual/logging/overview.html%3E%0A)

							- [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/operations_manual/logging/overview.md)

							- [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/operations_manual/logging/overview.md)
...
- [Log Types](#log-types) [Logging-Specific Types](#logging-specific-types)

- [Structured Logging](#structured-logging)

- [List of Available Log Types](#list-of-available-log-types)

- [Log Storages](#log-storages) [Logging to stdout](#logging-to-stdout)

- [Logging to File](#logging-to-file)

- [Advanced Usage](#advanced-usage) [Normalized vs. Denormalized Logging](#normalized-vs-denormalized-logging)
