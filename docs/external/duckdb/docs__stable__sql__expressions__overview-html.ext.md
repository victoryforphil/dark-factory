...
- Source page: /docs/stable/sql/expressions/overview.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, sql, expressions, overview html
- Summary: Search Shortcut cmd + k | ctrl + k
----

Source: https://duckdb.org/docs/stable/sql/expressions/overview.html
...
##### About this page
							...
							- [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/sql/expressions/overview.md)

							- [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/sql/expressions/overview.md)
