...
- Source page: /docs/stable/clients/cli/autocomplete.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, clients, cli, autocomplete html
- Summary: [![Image 1: DuckDB Logo for Download](http://duckdb.org/images/logo-dl/DuckDB_Logo-horizontal.svg)](https://duckdb.org/)
----

Source: https://duckdb.org/docs/stable/clients/cli/autocomplete.html
...
*   [1.5-dev"](http://duckdb.org/docs/preview/clients/cli/autocomplete)
*   [1.4](http://duckdb.org/docs/stable/clients/cli/autocomplete)
*   [1.3](http://duckdb.org/docs/1.3/clients/cli/autocomplete)
*   [1.2](http://duckdb.org/docs/1.2/clients/cli/autocomplete)
...
The shell offers context-aware autocomplete of SQL queries through the [```plaintext autocomplete ``` extension](http://duckdb.org/docs/stable/core_extensions/autocomplete.html). autocomplete is triggered by pressing 
```plaintext
Tab
```
.

Multiple autocomplete suggestions can be present. You can cycle forwards through the suggestions by repeatedly pressing 
```plaintext
Tab
```
, or 
...
Shift+Tab
```
 to cycle backwards. autocompletion can be reverted by pressing 
```plaintext
ESC
```
 twice.
...
*   [Report content issue](https://github.com/duckdb/duckdb-web/issues/new?title=Issue%20found%20on%20page%20%27Autocomplete%27&labels=issue%20found%20on%20page&body=%0A%3E%20Please%20describe%20the%20problem%20you%20encountered%20in%20the%20DuckDB%20documentation%20and%20include%20the%20%22Page%20URL%22%20link%20shown%20below.%0A%3E%20Note:%20only%20create%20an%20issue%20if%20you%20wish%20to%20report%20a%20problem%20with%20the%20DuckDB%20documentation.%20For%20questions%20about%20DuckDB%20or%20the%20use%20of%20certain%20DuckDB%20features,%20use%20[GitHub%20Discussions](https://github.com/duckdb/duckdb/discussions/),%20[Stack%20Overflow](https://stackoverflow.com/questions/tagged/duckdb),%20or%20[Discord](https://discord.duckdb.org/).%0A%0APage%20URL:%20%3Chttps://duckdb.org/docs/stable/clients/cli/autocomplete.html%3E%0A "Create GitHub issue")
*   [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/clients/cli/autocomplete.md "See Markdown")
*   [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/clients/cli/autocomplete.md "Go to GitHub")
