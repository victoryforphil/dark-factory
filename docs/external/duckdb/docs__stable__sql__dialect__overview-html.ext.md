...
- Source page: /docs/stable/sql/dialect/overview.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, sql, dialect, overview html
- Summary: Search Shortcut cmd + k | ctrl + k
----

Source: https://duckdb.org/docs/stable/sql/dialect/overview.html
...
For example, interchangeability with data frame libraries necessitates [order preservation of inserts](/docs/stable/sql/dialect/order_preservation.html) to be supported by default.
...
##### About this page
							...
							- [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/sql/dialect/overview.md)

							- [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/sql/dialect/overview.md)
