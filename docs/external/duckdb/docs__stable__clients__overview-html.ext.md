...
- Source page: /docs/stable/clients/overview.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, clients, overview html
- Summary: [![Image 1: DuckDB Logo for Download](http://duckdb.org/images/logo-dl/DuckDB_Logo-horizontal.svg)](https://duckdb.org/)
----

Source: https://duckdb.org/docs/stable/clients/overview.html
...
*   [1.5-dev"](http://duckdb.org/docs/preview/clients/overview)
*   [1.4](http://duckdb.org/docs/stable/clients/overview)
*   [1.3](http://duckdb.org/docs/1.3/clients/overview)
*   [1.2](http://duckdb.org/docs/1.2/clients/overview)
...
| --- | --- | --- | --- |
| [C](http://duckdb.org/docs/stable/clients/c/overview.html) | Core team | Primary | [1.4.4](http://duckdb.org/install/?version=stable&environment=cplusplus) |
| [Command Line Interface (CLI)](http://duckdb.org/docs/stable/clients/cli/overview.html) | Core team | Primary | [1.4.4](http://duckdb.org/install/?version=stable&environment=cli) |
| [Java (JDBC)](http://duckdb.org/docs/stable/clients/java.html) | Core team | Primary | [1.4.4](https://central.sonatype.com/artifact/org.duckdb/duckdb_jdbc) |
| [Go](http://duckdb.org/docs/stable/clients/go.html) | Core team | Primary | [1.4.4](https://github.com/duckdb/duckdb-go#readme) |
| [Node.js (node-neo)](http://duckdb.org/docs/stable/clients/node_neo/overview.html) | [Jeff Raymakers](https://github.com/jraymakers) | Primary | [1.4.4](https://www.npmjs.com/package/@duckdb/node-api) |
| [ODBC](http://duckdb.org/docs/stable/clients/odbc/overview.html) | Core team | Primary | [1.4.4](http://duckdb.org/install/?version=stable&environment=odbc) |
| [Python](http://duckdb.org/docs/stable/clients/python/overview.html) | Core team | Primary | [1.4.4](https://pypi.org/project/duckdb/) |
| [R](http://duckdb.org/docs/stable/clients/r.html) | [Kirill Müller](https://github.com/krlmlr) | Primary | [1.4.4](https://cran.r-project.org/web/packages/duckdb/index.html) |
| [Rust](http://duckdb.org/docs/stable/clients/rust.html) | Core team | Primary | [1.4.4](https://crates.io/crates/duckdb) |
| [WebAssembly (Wasm)](http://duckdb.org/docs/stable/clients/wasm/overview.html) | Core team | Primary | [1.4.4](https://github.com/duckdb/duckdb-wasm#readme) |
| [ADBC (Arrow)](http://duckdb.org/docs/stable/clients/adbc.html) | Core team | Secondary | [1.4.4](http://duckdb.org/docs/stable/clients/adbc.html) |
| [C# (.NET)](https://duckdb.net/) | [Giorgi](https://github.com/Giorgi) | Secondary | [1.4.4](https://www.nuget.org/packages?q=Tags%3A%22DuckDB%22+Author%3A%22Giorgi%22&includeComputedFrameworks=true&prerel=true&sortby=relevance) |
| [C++](http://duckdb.org/docs/stable/clients/cpp.html) | Core team | Secondary | [1.4.4](http://duckdb.org/install/?version=stable&environment=cplusplus) |
| [Node.js (deprecated)](http://duckdb.org/docs/stable/clients/nodejs/overview.html) | Core team | Secondary | [1.4.4](https://www.npmjs.com/package/duckdb) |

For a list of tertiary clients, see the [“Tertiary Clients” page](http://duckdb.org/docs/stable/clients/tertiary.html).

[Support Tiers](http://duckdb.org/docs/stable/clients/overview.html#support-tiers)
----------------------------------------------------------------------------------

There are three tiers of support for clients. Primary clients are the first to receive new features and are covered by [community support](https://duckdblabs.com/community_support_policy). Secondary clients receive new features but are not covered by community support. Finally, there are no feature or support guarantees for tertiary clients.
...
[Compatibility](http://duckdb.org/docs/stable/clients/overview.html#compatibility)
----------------------------------------------------------------------------------

All DuckDB clients support the same DuckDB SQL syntax and use the same on-disk [database format](http://duckdb.org/docs/stable/internals/storage.html). [DuckDB extensions](http://duckdb.org/docs/stable/extensions/overview.html) are also portable between clients with some exceptions (see [Wasm extensions](http://duckdb.org/docs/stable/clients/wasm/extensions.html#list-of-officially-available-extensions)).
...
*   [Report content issue](https://github.com/duckdb/duckdb-web/issues/new?title=Issue%20found%20on%20page%20%27Client%20Overview%27&labels=issue%20found%20on%20page&body=%0A%3E%20Please%20describe%20the%20problem%20you%20encountered%20in%20the%20DuckDB%20documentation%20and%20include%20the%20%22Page%20URL%22%20link%20shown%20below.%0A%3E%20Note:%20only%20create%20an%20issue%20if%20you%20wish%20to%20report%20a%20problem%20with%20the%20DuckDB%20documentation.%20For%20questions%20about%20DuckDB%20or%20the%20use%20of%20certain%20DuckDB%20features,%20use%20[GitHub%20Discussions](https://github.com/duckdb/duckdb/discussions/),%20[Stack%20Overflow](https://stackoverflow.com/questions/tagged/duckdb),%20or%20[Discord](https://discord.duckdb.org/).%0A%0APage%20URL:%20%3Chttps://duckdb.org/docs/stable/clients/overview.html%3E%0A "Create GitHub issue")
*   [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/clients/overview.md "See Markdown")
*   [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/clients/overview.md "Go to GitHub")
