...
- Source page: /docs/stable/data/json/overview.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, data, json, overview html
- Summary: Search Shortcut cmd + k | ctrl + k
----

Source: https://duckdb.org/docs/stable/data/json/overview.html
...
If you would like to install or load it manually, please consult the [“Installing and Loading” page](/docs/stable/data/json/installing_and_loading.html).
...
Warning Following [PostgreSQL's conventions](/docs/stable/sql/dialect/postgresql_compatibility.html), DuckDB uses 1-based indexing for its [`ARRAY`](/docs/stable/sql/data_types/array.html) and [`LIST`](/docs/stable/sql/data_types/list.html) data types but [0-based indexing for the JSON data type](https://www.postgresql.org/docs/17/functions-json.html#FUNCTIONS-JSON-PROCESSING).
...
Alternatively, create a table without specifying the schema manually with a [`CREATE TABLE ... AS SELECT` clause](/docs/stable/sql/statements/create_table.html#create-table--as-select-ctas):
...
##### About this page
							...
							- [Report content issue](https://github.com/duckdb/duckdb-web/issues/new?title=Issue%20found%20on%20page%20'JSON%20Overview'&labels=issue%20found%20on%20page&body=%0A%3E%20Please%20describe%20the%20problem%20you%20encountered%20in%20the%20DuckDB%20documentation%20and%20include%20the%20%22Page%20URL%22%20link%20shown%20below.%0A%3E%20Note:%20only%20create%20an%20issue%20if%20you%20wish%20to%20report%20a%20problem%20with%20the%20DuckDB%20documentation.%20For%20questions%20about%20DuckDB%20or%20the%20use%20of%20certain%20DuckDB%20features,%20use%20[GitHub%20Discussions](https://github.com/duckdb/duckdb/discussions/),%20[Stack%20Overflow](https://stackoverflow.com/questions/tagged/duckdb),%20or%20[Discord](https://discord.duckdb.org/).%0A%0APage%20URL:%20%3Chttps://duckdb.org/docs/stable/data/json/overview.html%3E%0A)

							- [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/data/json/overview.md)

							- [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/data/json/overview.md)
...
- [Examples](#examples) [Loading JSON](#loading-json)
