...
- Source page: /docs/stable/clients/c/overview.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, clients, c, overview html
- Summary: [![Image 1: DuckDB Logo for Download](http://duckdb.org/images/logo-dl/DuckDB_Logo-horizontal.svg)](https://duckdb.org/)
----

Source: https://duckdb.org/docs/stable/clients/c/overview.html
...
*   [1.5-dev"](http://duckdb.org/docs/preview/clients/c/overview)
*   [1.4](http://duckdb.org/docs/stable/clients/c/overview)
*   [1.3](http://duckdb.org/docs/1.3/clients/c/overview)
*   [1.2](http://duckdb.org/docs/1.2/clients/c/overview)
...
> The latest stable version of the DuckDB C API is 1.4.4.

DuckDB implements a custom C API modeled somewhat following the SQLite C API. The API is contained in the 
```plaintext
duckdb.h
```
 header. Continue to [Startup & Shutdown](http://duckdb.org/docs/stable/clients/c/connect.html) to get started, or check out the [Full API overview](http://duckdb.org/docs/stable/clients/c/api.html).

We also provide a SQLite API wrapper which means that if your applications is programmed against the SQLite C API, you can re-link to DuckDB and it should continue working. See the [```plaintext sqlite_api_wrapper ```](https://github.com/duckdb/duckdb/tree/main/tools/sqlite3_api_wrapper) folder in our source repository for more information.

[Installation](http://duckdb.org/docs/stable/clients/c/overview.html#installation)
----------------------------------------------------------------------------------

The DuckDB C API can be installed as part of the 
```plaintext
libduckdb
```
 packages. Please see the [installation page](http://duckdb.org/install/?environment=cplusplus) for details.
...
*   [Report content issue](https://github.com/duckdb/duckdb-web/issues/new?title=Issue%20found%20on%20page%20%27Overview%27&labels=issue%20found%20on%20page&body=%0A%3E%20Please%20describe%20the%20problem%20you%20encountered%20in%20the%20DuckDB%20documentation%20and%20include%20the%20%22Page%20URL%22%20link%20shown%20below.%0A%3E%20Note:%20only%20create%20an%20issue%20if%20you%20wish%20to%20report%20a%20problem%20with%20the%20DuckDB%20documentation.%20For%20questions%20about%20DuckDB%20or%20the%20use%20of%20certain%20DuckDB%20features,%20use%20[GitHub%20Discussions](https://github.com/duckdb/duckdb/discussions/),%20[Stack%20Overflow](https://stackoverflow.com/questions/tagged/duckdb),%20or%20[Discord](https://discord.duckdb.org/).%0A%0APage%20URL:%20%3Chttps://duckdb.org/docs/stable/clients/c/overview.html%3E%0A "Create GitHub issue")
*   [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/clients/c/overview.md "See Markdown")
*   [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/clients/c/overview.md "Go to GitHub")
