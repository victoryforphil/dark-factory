...
- Source page: /docs/stable/guides/overview.html
- Keywords: duckdb, docs, client apis, cli, node neo, rust, wasm, guides, overview html
- Summary: Search Shortcut cmd + k | ctrl + k
----

Source: https://duckdb.org/docs/stable/guides/overview.html
				...
				- Documentation
						...
						- Data Import and Export
							...
							- JSON Files
								...
								- [Format Settings](/docs/stable/data/json/format_settings)

								- [Installing and Loading](/docs/stable/data/json/installing_and_loading)
						...
						- [Lakehouse Formats](/docs/stable/lakehouse_formats)

						- Client APIs

							- [Overview](/docs/stable/clients/overview)

							- [Tertiary Clients](/docs/stable/clients/tertiary)
							...
							- Wasm
								...
								- [Deploying DuckDB-Wasm](/docs/stable/clients/wasm/deploying_duckdb_wasm)
						...
						- SQL
							...
							- Statements
								...
								- [CREATE SCHEMA](/docs/stable/sql/statements/create_schema)

								- [CREATE SECRET](/docs/stable/sql/statements/create_secret)

								- [CREATE SEQUENCE](/docs/stable/sql/statements/create_sequence)
								...
								- [EXPORT and IMPORT DATABASE](/docs/stable/sql/statements/export)

								- [INSERT](/docs/stable/sql/statements/insert)

								- [LOAD / INSTALL](/docs/stable/sql/statements/load_and_install)

								- [MERGE INTO](/docs/stable/sql/statements/merge_into)
								...
								- [SHOW and SHOW DATABASES](/docs/stable/sql/statements/show)
							...
							- Meta Queries
								...
								- [Metadata Functions](/docs/stable/sql/meta/duckdb_table_functions)
						...
						- Extensions
							...
							- [Distributing Extensions](/docs/stable/extensions/extension_distribution)

							- [Versioning of Extensions](/docs/stable/extensions/versioning_of_extensions)

							- [Troubleshooting of Extensions](/docs/stable/extensions/troubleshooting)
						...
						- Core Extensions
							...
							- [Full Text Search](/docs/stable/core_extensions/full_text_search)

							- httpfs (HTTP and S3)

								- [Overview](/docs/stable/core_extensions/httpfs/overview)

								- [HTTP(S) Support](/docs/stable/core_extensions/httpfs/https)

								- [Hugging Face](/docs/stable/core_extensions/httpfs/hugging_face)

								- [S3 API Support](/docs/stable/core_extensions/httpfs/s3api)

								- [Legacy Authentication Scheme for S3 API](/docs/stable/core_extensions/httpfs/s3api_legacy_authentication)

							- Iceberg

								- [Overview](/docs/stable/core_extensions/iceberg/overview)

								- [Iceberg REST Catalogs](/docs/stable/core_extensions/iceberg/iceberg_rest_catalogs)

								- [Amazon S3 Tables](/docs/stable/core_extensions/iceberg/amazon_s3_tables)

								- [Amazon SageMaker Lakehouse (AWS Glue)](/docs/stable/core_extensions/iceberg/amazon_sagemaker_lakehouse)
							...
							- Spatial
								...
								- [Function Reference](/docs/stable/core_extensions/spatial/functions)

								- [R-Tree Indexes](/docs/stable/core_extensions/spatial/r-tree_indexes)

								- [GDAL Integration](/docs/stable/core_extensions/spatial/gdal)
							...
							- [Unity Catalog](/docs/stable/core_extensions/unity_catalog)

							- [Vortex](/docs/stable/core_extensions/vortex)
						...
						- Guides
							...
							- Network and Cloud Storage
								...
								- [GCS Import](/docs/stable/guides/network_cloud_storage/gcs_import)

								- [Cloudflare R2 Import](/docs/stable/guides/network_cloud_storage/cloudflare_r2_import)

								- [DuckDB over HTTPS / S3](/docs/stable/guides/network_cloud_storage/duckdb_over_https_or_s3)
							...
							- Performance
								...
								- [Working with Huge Databases](/docs/stable/guides/performance/working_with_huge_databases)
							...
							- Python
								...
								- [Import from Arrow](/docs/stable/guides/python/import_arrow)

								- [Export to Arrow](/docs/stable/guides/python/export_arrow)
							...
							- SQL Features
								...
								- [Graph Queries](/docs/stable/guides/sql_features/graph_queries)

								- [query and query_table Functions](/docs/stable/guides/sql_features/query_and_query_table_functions)

								- [Merge Statement for SCD Type 2](/docs/stable/guides/sql_features/merge)

								- [Timestamp Issues](/docs/stable/guides/sql_features/timestamps)

							- Snippets

								- [Creating Synthetic Data](/docs/stable/guides/snippets/create_synthetic_data)

								- [Dutch Railway Datasets](/docs/stable/guides/snippets/dutch_railway_datasets)
							...
							- Troubleshooting
								...
								- [Out of Memory Errors](/docs/stable/guides/troubleshooting/oom_errors)
						...
						- Operations Manual
							...
							- Installing DuckDB
								...
								- [Install Script](/docs/stable/operations_manual/installing_duckdb/install_script)
							...
							- [DuckDB Docker Container](/docs/stable/operations_manual/duckdb_docker)

						- Development

							- [DuckDB Repositories](/docs/stable/dev/repositories)

							- [Release Cycle](/docs/stable/dev/release_cycle)
							...
							- Building DuckDB
								...
								- [Build Configuration](/docs/stable/dev/building/build_configuration)
...
Tip For a short introductory tutorial, check out the [“Analyzing Railway Traffic in the Netherlands”](/2024/05/31/analyzing-railway-traffic-in-the-netherlands.html) tutorial.

## [Data Import and Export](#data-import-and-export)

  - [Data import overview](/docs/stable/guides/file_formats/overview.html)

  - [File access with the `file:` protocol](/docs/stable/guides/file_formats/file_access.html)

### [CSV Files](#csv-files)

  - [How to load a CSV file into a table](/docs/stable/guides/file_formats/csv_import.html)

  - [How to export a table to a CSV file](/docs/stable/guides/file_formats/csv_export.html)

### [Parquet Files](#parquet-files)

  - [How to load a Parquet file into a table](/docs/stable/guides/file_formats/parquet_import.html)

  - [How to export a table to a Parquet file](/docs/stable/guides/file_formats/parquet_export.html)

  - [How to run a query directly on a Parquet file](/docs/stable/guides/file_formats/query_parquet.html)

### [HTTP(S), S3 and GCP](#https-s3-and-gcp)

  - [How to load a Parquet file directly from HTTP(S)](/docs/stable/guides/network_cloud_storage/http_import.html)

  - [How to load a Parquet file directly from S3](/docs/stable/guides/network_cloud_storage/s3_import.html)

  - [How to export a Parquet file to S3](/docs/stable/guides/network_cloud_storage/s3_export.html)

  - [How to load a Parquet file from S3 Express One](/docs/stable/guides/network_cloud_storage/s3_express_one.html)

  - [How to load a Parquet file directly from GCS](/docs/stable/guides/network_cloud_storage/gcs_import.html)

  - [How to load a Parquet file directly from Cloudflare R2](/docs/stable/guides/network_cloud_storage/cloudflare_r2_import.html)

  - [How to load an Iceberg table directly from S3](/docs/stable/guides/network_cloud_storage/s3_iceberg_import.html)

### [JSON Files](#json-files)

  - [How to load a JSON file into a table](/docs/stable/guides/file_formats/json_import.html)

  - [How to export a table to a JSON file](/docs/stable/guides/file_formats/json_export.html)

### [Excel Files with the Spatial Extension](#excel-files-with-the-spatial-extension)

  - [How to load an Excel file into a table](/docs/stable/guides/file_formats/excel_import.html)

  - [How to export a table to an Excel file](/docs/stable/guides/file_formats/excel_export.html)

### [Querying Other Database Systems](#querying-other-database-systems)

  - [How to directly query a MySQL database](/docs/stable/guides/database_integration/mysql.html)

  - [How to directly query a PostgreSQL database](/docs/stable/guides/database_integration/postgres.html)

  - [How to directly query a SQLite database](/docs/stable/guides/database_integration/sqlite.html)

### [Directly Reading Files](#directly-reading-files)

  - [How to directly read a binary file](/docs/stable/guides/file_formats/read_file.html#read_blob)

  - [How to directly read a text file](/docs/stable/guides/file_formats/read_file.html#read_text)

## [Performance](#performance)

  - [My workload is slow (troubleshooting guide)](/docs/stable/guides/performance/my_workload_is_slow.html)

  - [How to design the schema for optimal performance](/docs/stable/guides/performance/schema.html)

  - [What is the ideal hardware environment for DuckDB](/docs/stable/guides/performance/environment.html)

  - [What performance implications do Parquet files and (compressed) CSV files have](/docs/stable/guides/performance/file_formats.html)

  - [How to tune workloads](/docs/stable/guides/performance/how_to_tune_workloads.html)

  - [Benchmarks](/docs/stable/guides/performance/benchmarks.html)

## [Meta Queries](#meta-queries)

  - [How to list all tables](/docs/stable/guides/meta/list_tables.html)

  - [How to view the schema of the result of a query](/docs/stable/guides/meta/describe.html)

  - [How to quickly get a feel for a dataset using summarize](/docs/stable/guides/meta/summarize.html)

  - [How to view the query plan of a query](/docs/stable/guides/meta/explain.html)

  - [How to profile a query](/docs/stable/guides/meta/explain_analyze.html)

## [ODBC](#odbc)

  - [How to set up an ODBC application (and more!)](/docs/stable/guides/odbc/general.html)

## [Python Client](#python-client)

  - [How to install the Python client](/docs/stable/guides/python/install.html)

  - [How to execute SQL queries](/docs/stable/guides/python/execute_sql.html)

  - [How to easily query DuckDB in Jupyter Notebooks](/docs/stable/guides/python/jupyter.html)

  - [How to easily query DuckDB in marimo Notebooks](/docs/stable/guides/python/marimo.html)

  - [How to use Multiple Python Threads with DuckDB](/docs/stable/guides/python/multiple_threads.html)

  - [How to use fsspec filesystems with DuckDB](/docs/stable/guides/python/filesystems.html)

### [Pandas](#pandas)

  - [How to execute SQL on a Pandas DataFrame](/docs/stable/guides/python/sql_on_pandas.html)

  - [How to create a table from a Pandas DataFrame](/docs/stable/guides/python/import_pandas.html)

  - [How to export data to a Pandas DataFrame](/docs/stable/guides/python/export_pandas.html)

### [Apache Arrow](#apache-arrow)

  - [How to execute SQL on Apache Arrow](/docs/stable/guides/python/sql_on_arrow.html)

  - [How to create a DuckDB table from Apache Arrow](/docs/stable/guides/python/import_arrow.html)

  - [How to export data to Apache Arrow](/docs/stable/guides/python/export_arrow.html)

### [Relational API](#relational-api)

  - [How to query Pandas DataFrames with the Relational API](/docs/stable/guides/python/relational_api_pandas.html)

### [Python Library Integrations](#python-library-integrations)

  - [How to use Ibis to query DuckDB with or without SQL](/docs/stable/guides/python/ibis.html)

  - [How to use DuckDB with Polars DataFrames via Apache Arrow](/docs/stable/guides/python/polars.html)

## [SQL Features](#sql-features)

  - [Friendly SQL](/docs/stable/sql/dialect/friendly_sql.html)

  - [As-of join](/docs/stable/guides/sql_features/asof_join.html)

  - [Full-text search](/docs/stable/guides/sql_features/full_text_search.html)

  - [Graph queries](/docs/stable/guides/sql_features/graph_queries.html)

  - [`query` and `query_table` functions](/docs/stable/guides/sql_features/query_and_query_table_functions.html)

## [SQL Editors and IDEs](#sql-editors-and-ides)

  - [How to set up the DBeaver SQL IDE](/docs/stable/guides/sql_editors/dbeaver.html)

## [Data Viewers](#data-viewers)

  - [How to visualize DuckDB databases with Tableau](/docs/stable/guides/data_viewers/tableau.html)

  - [How to draw command-line plots with DuckDB and YouPlot](/docs/stable/guides/data_viewers/youplot.html)

## Pages in This Section

##### About this page

							- [Report content issue](https://github.com/duckdb/duckdb-web/issues/new?title=Issue%20found%20on%20page%20'Guides'&labels=issue%20found%20on%20page&body=%0A%3E%20Please%20describe%20the%20problem%20you%20encountered%20in%20the%20DuckDB%20documentation%20and%20include%20the%20%22Page%20URL%22%20link%20shown%20below.%0A%3E%20Note:%20only%20create%20an%20issue%20if%20you%20wish%20to%20report%20a%20problem%20with%20the%20DuckDB%20documentation.%20For%20questions%20about%20DuckDB%20or%20the%20use%20of%20certain%20DuckDB%20features,%20use%20[GitHub%20Discussions](https://github.com/duckdb/duckdb/discussions/),%20[Stack%20Overflow](https://stackoverflow.com/questions/tagged/duckdb),%20or%20[Discord](https://discord.duckdb.org/).%0A%0APage%20URL:%20%3Chttps://duckdb.org/docs/stable/guides/overview.html%3E%0A)

							- [See this page as Markdown](https://raw.githubusercontent.com/duckdb/duckdb-web/refs/heads/main/docs/stable/guides/overview.md)

							- [Edit this page on GitHub](https://github.com/duckdb/duckdb-web/edit/main/docs/stable/guides/overview.md)

© 2025 DuckDB Foundation, Amsterdam NL

						[Code of Conduct](/code_of_conduct.html)
						[Trademark Use](/trademark_guidelines.html)

##### In this article

- [Data Import and Export](#data-import-and-export) [CSV Files](#csv-files)
...
- [Python Client](#python-client) [Pandas](#pandas)
