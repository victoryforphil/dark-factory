...
- Source page: /examples/widgets/paragraph
- Keywords: ratatui, rust, tui, terminal ui, docs, examples, widgets, paragraph
- Summary: Demonstrates the [`Paragraph`](https://docs.rs/ratatui/latest/ratatui/widgets/struct.Paragraph.html)
----

Source: https://ratatui.rs/examples/widgets/paragraph
...
```
 ...
 [Edit page](https://github.com/ratatui/ratatui-website/edit/main/src/content/docs/examples/Widgets/paragraph.md)

 [Previous List](/examples/widgets/list/) [Next Scrollbar](/examples/widgets/scrollbar/)
