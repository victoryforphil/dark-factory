...
- Source page: /examples/apps/hello_world
- Keywords: ratatui, rust, tui, terminal ui, docs, examples, apps, hello world
- Summary: Demonstrates a basic hello world app. Source
----

Source: https://ratatui.rs/examples/apps/hello_world
...
```
 ...
 [Edit page](https://github.com/ratatui/ratatui-website/edit/main/src/content/docs/examples/Apps/hello_world.md)

 [Previous Docs.rs](/examples/apps/docsrs/) [Next Inline Viewport](/examples/apps/inline/)
