...
- Source page: /tutorials/counter-app
- Keywords: ratatui, rust, tui, terminal ui, docs, tutorials, counter app
- Summary: The previous [Hello Ratatui](/tutorials/hello-ratatui) tutorial introduced how to create a simple TUI that displayed some text
----

Source: https://ratatui.rs/tutorials/counter-app
...
and right arrow keys, the application will increment and decrement the value of the counter.
 ...
 [Edit page](https://github.com/ratatui/ratatui-website/edit/main/src/content/docs/tutorials/counter-app/index.md)

 [Previous Hello Ratatui](/tutorials/hello-ratatui/) [Next Basic App](/tutorials/counter-app/basic-app/)
