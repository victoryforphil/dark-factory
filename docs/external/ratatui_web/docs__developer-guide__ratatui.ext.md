...
- Source page: /developer-guide/ratatui
- Keywords: ratatui, rust, tui, terminal ui, docs, developer guide, ratatui
- Summary: Check out the [CONTRIBUTING GUIDE](https://github.com/ratatui/ratatui/blob/main/CONTRIBUTING.md) for
----

Source: https://ratatui.rs/developer-guide/ratatui
...
```
let style = Style::new().red().bold();// notlet style = Style::default().fg(Color::Red).add_modifier(Modifiers::BOLD);
```
...
```
/// Summary////// A detailed description/// with examples.fn foo() {}
```
...
```
/// doc comment#[derive(Debug)]struct Foo {}
```
...
to update. However, if a deprecation is blocking for us to implement a new feature we may consider
...
You can then resume the conversation by replying to this new issue you have created.
 ...
 [Edit page](https://github.com/ratatui/ratatui-website/edit/main/src/content/docs/developer-guide/ratatui.md)

 [Previous Developer Guide](/developer-guide/) [Next Contributing to Ratatui Website](/developer-guide/website/)
