...
- Source page: /examples/apps/docsrs
- Keywords: ratatui, rust, tui, terminal ui, docs, examples, apps, docsrs
- Summary: Several examples used for importing into the main docs.rs page.
----

Source: https://ratatui.rs/examples/apps/docsrs
...
```
 ...
 [Edit page](https://github.com/ratatui/ratatui-website/edit/main/src/content/docs/examples/Apps/docsrs.md)

 [Previous Demo 2](/examples/apps/demo2/) [Next Hello World](/examples/apps/hello_world/)
