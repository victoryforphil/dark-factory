...
- Source page: /docs/orm/prisma-schema/data-model/relations
- Keywords: prisma, prisma schema, orm, docs, docs, orm, prisma schema, data model, relations
- Summary: A relation is a _connection_ between two models in the Prisma schema. For example, there is a one-to-many relation between `User` and `Post` because one user can have many blog posts.
----
...
*   Two [relation fields](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#relation-fields): `author` and `posts`. Relation fields define connections between models at the Prisma ORM level and **do not exist in the database**. These fields are used to generate Prisma Client.
...
At a Prisma ORM level, a connection between two models is **always** represented by a [relation field](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#relation-fields) on **each side** of the relation.

Relations in the database[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#relations-in-the-database "Direct link to Relations in the database")
-------------------------------------------------------------------------------------------------------------------------------------------------------------------

### Relational databases[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#relational-databases "Direct link to Relational databases")
...
![Image 1: A one-to-many relationship between a user and posts table.](blob:http://localhost/f04e87747e64645c4c07647b66b74608)
...
### MongoDB[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#mongodb "Direct link to MongoDB")
...
#### `@db.ObjectId` on IDs and relation scalar fields[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#dbobjectid-on-ids-and-relation-scalar-fields "Direct link to dbobjectid-on-ids-and-relation-scalar-fields")
...
Relations in Prisma Client[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#relations-in-prisma-client "Direct link to Relations in Prisma Client")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### Create a record and nested records[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#create-a-record-and-nested-records "Direct link to Create a record and nested records")
...
### Retrieve a record and include related records[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#retrieve-a-record-and-include-related-records "Direct link to Retrieve a record and include related records")
...
### Associate an existing record to another existing record[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#associate-an-existing-record-to-another-existing-record "Direct link to Associate an existing record to another existing record")
...
Types of relations[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#types-of-relations "Direct link to Types of relations")
----------------------------------------------------------------------------------------------------------------------------------------------
...
![Image 2: The sample schema as an entity relationship diagram](https://www.prisma.io/docs/assets/images/sample-schema-062be9f897083a8ddc33eec928a2dec9.png)

For MongoDB, Prisma ORM uses a [normalized data model design](https://www.mongodb.com/docs/manual/data-modeling/), which means that documents reference each other by ID in a similar way to relational databases. See [the MongoDB section](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#mongodb) for more details.

### Implicit and explicit many-to-many relations[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#implicit-and-explicit-many-to-many-relations "Direct link to Implicit and explicit many-to-many relations")
...
Relation fields[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#relation-fields "Direct link to Relation fields")
-------------------------------------------------------------------------------------------------------------------------------------
...
Also note that the [annotated relation field](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#annotated-relation-fields)`author` needs to link the relation scalar field `authorId` on the `Post` model inside the `@relation` attribute. The relation scalar field represents the foreign key in the underlying database.
...
### Annotated relation fields[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#annotated-relation-fields "Direct link to Annotated relation fields")
...
### Relation scalar fields[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#relation-scalar-fields "Direct link to Relation scalar fields")

#### Relation scalar field naming conventions[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#relation-scalar-field-naming-conventions "Direct link to Relation scalar field naming conventions")
...
The `@relation` attribute[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#the-relation-attribute "Direct link to the-relation-attribute")
-------------------------------------------------------------------------------------------------------------------------------------------------------------

The [`@relation`](https://www.prisma.io/docs/orm/reference/prisma-schema-reference#relation) attribute can only be applied to the [relation fields](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#relation-fields), not to [scalar fields](https://www.prisma.io/docs/orm/prisma-schema/data-model/models#scalar-fields).
...
Disambiguating relations[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations#disambiguating-relations "Direct link to Disambiguating relations")
----------------------------------------------------------------------------------------------------------------------------------------------------------------
