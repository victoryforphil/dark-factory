...
- Source page: /docs/orm/prisma-schema/data-model/relations/one-to-one-relations
- Keywords: prisma, prisma schema, orm, docs, docs, orm, prisma schema, data model, relations, one to one relations
- Summary: Learn how to define and use one-to-one (1-1) relations in your Prisma schema, including modeling choices and key concepts.
----
...
Overview[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/one-to-one-relations#overview "Direct link to Overview")
-------------------------------------------------------------------------------------------------------------------------------------
...
Multi-field relations in relational databases[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/one-to-one-relations#multi-field-relations-in-relational-databases "Direct link to Multi-field relations in relational databases")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
1-1 relations in the database[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/one-to-one-relations#1-1-relations-in-the-database "Direct link to 1-1 relations in the database")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

### Relational databases[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/one-to-one-relations#relational-databases "Direct link to Relational databases")
...
### MongoDB[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/one-to-one-relations#mongodb "Direct link to MongoDB")
...
Required and optional 1-1 relation fields[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/one-to-one-relations#required-and-optional-1-1-relation-fields "Direct link to Required and optional 1-1 relation fields")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### Mandatory 1-1 relation[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/one-to-one-relations#mandatory-1-1-relation "Direct link to Mandatory 1-1 relation")
...
### Optional 1-1 relation[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/one-to-one-relations#optional-1-1-relation "Direct link to Optional 1-1 relation")
...
Choosing which side should store the foreign key in a 1-1 relation[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/one-to-one-relations#choosing-which-side-should-store-the-foreign-key-in-a-1-1-relation "Direct link to Choosing which side should store the foreign key in a 1-1 relation")
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
