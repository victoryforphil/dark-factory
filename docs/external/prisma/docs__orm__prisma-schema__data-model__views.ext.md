...
- Source page: /docs/orm/prisma-schema/data-model/views
- Keywords: prisma, prisma schema, orm, docs, docs, orm, prisma schema, data model, views
- Summary: Database views allow you to name and store queries. In relational databases, views are [stored SQL queries](https://www.postgresql.org/docs/current/sql-createview.html) that might include columns in multiple tables, or calculated values ...
----
...
1.   [Enable the `views` preview feature](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#enable-the-views-preview-feature)
2.   [Create a view in the underlying database](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#create-a-view-in-the-underlying-database), either directly or as a [manual addition to a Prisma Migrate migration file](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#use-views-with-prisma-migrate-and-db-push), or use an existing view
3.   [Represent the view in your Prisma schema](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#add-views-to-your-prisma-schema)
4.   [Query the view in Prisma Client](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#query-views-in-prisma-client)

warning

Support for views is currently a [Preview](https://www.prisma.io/docs/orm/more/releases#preview) feature. You can add a view to your Prisma schema with the `view` keyword or introspect the views in your database schema with `db pull`. You cannot yet apply views in your schema to your database with Prisma Migrate and `db push` unless the changes are added manually to your migration file using the `--create-only` flag.
...
Enable the `views` preview feature[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#enable-the-views-preview-feature "Direct link to enable-the-views-preview-feature")
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
`generator client {  provider        = "prisma-client"  output          = "./generated"  previewFeatures = ["views"]}`
...
Create a view in the underlying database[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#create-a-view-in-the-underlying-database "Direct link to Create a view in the underlying database")
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Currently, you cannot apply views that you define in your Prisma schema to your database with Prisma Migrate or `db push`. Instead, you must first create the view in the underlying database, either manually or [as part of a migration](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#use-views-with-prisma-migrate-and-db-push).
...
Use views with Prisma Migrate and `db push`[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#use-views-with-prisma-migrate-and-db-push "Direct link to use-views-with-prisma-migrate-and-db-push")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Add views to your Prisma schema[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#add-views-to-your-prisma-schema "Direct link to Add views to your Prisma schema")
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
`view UserInfo {  id    Int  email String  name  String  bio   String}`

### Write by hand[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#write-by-hand "Direct link to Write by hand")
...
#### Define a `view` block[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#define-a-view-block "Direct link to define-a-view-block")
...
#### Define fields[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#define-fields "Direct link to Define fields")
...
### Use introspection[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#use-introspection "Direct link to Use introspection")
...
#### The `views` directory[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#the-views-directory "Direct link to the-views-directory")
...
Query views in Prisma Client[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#query-views-in-prisma-client "Direct link to Query views in Prisma Client")
------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Special types of views[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#special-types-of-views "Direct link to Special types of views")
------------------------------------------------------------------------------------------------------------------------------------------------------

This section describes how to use Prisma ORM with updatable and materialized views in your database.

### Updatable views[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#updatable-views "Direct link to Updatable views")
...
### Materialized views[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#materialized-views "Direct link to Materialized views")
...
Currently, Prisma ORM does not support materialized views. However, when you [manually create a view](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#create-a-view-in-the-underlying-database), you can also create a materialized view with the corresponding command in the underlying database. You can then use Prisma Client's [TypedSQL functionality](https://www.prisma.io/docs/orm/prisma-client/using-raw-sql) to execute the command and refresh the view manually.
...
Limitations[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#limitations "Direct link to Limitations")
---------------------------------------------------------------------------------------------------------------------
...
### No identifiers[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#no-identifiers "Direct link to No identifiers")

Views are virtual tables and do not have inherent primary keys. Hence, you cannot define `@id`, `@@id` attributes on a `view` block.

### No indexes[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#no-indexes "Direct link to No indexes")

Because views are virtual tables, they cannot have indexes. Therefore, `@index` and `@@index` cannot be defined on `view` blocks.

### Unsafe `@unique` attributes[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#unsafe-unique-attributes "Direct link to unsafe-unique-attributes")
...
### Disabled write queries[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/views#disabled-write-queries "Direct link to Disabled write queries")
