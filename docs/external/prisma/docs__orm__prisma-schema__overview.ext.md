...
- Source page: /docs/orm/prisma-schema/overview
- Keywords: prisma, prisma schema, orm, docs, docs, orm, prisma schema, overview
- Summary: The Prisma Schema (or schema for short) is the main method of configuration for your Prisma ORM setup. It consists of the following parts:
----
...
- [Data model definition](/docs/orm/prisma-schema/data-model): Specifies your application [models](/docs/orm/prisma-schema/data-model/models#defining-models) (the shape of the data per data source) and their [relations](/docs/orm/prisma-schema/data-model/relations)
...
See the [Prisma schema API reference](/docs/orm/reference/prisma-schema-reference)  for detailed information about each section of the schema.
...
See [Environment variables](/docs/orm/more/development-environment/environment-variables) for more information about how to use an `.env` file during development.
...
- Run the [`prisma format`](/docs/orm/reference/prisma-cli-reference#format) command.
