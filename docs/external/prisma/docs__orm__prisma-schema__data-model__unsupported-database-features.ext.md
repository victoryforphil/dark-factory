...
- Source page: /docs/orm/prisma-schema/data-model/unsupported-database-features
- Keywords: prisma, prisma schema, orm, docs, docs, orm, prisma schema, data model, unsupported database features
- Summary: Not all database functions and features of Prisma ORM's supported databases have a Prisma Schema Language equivalent. Refer to the [database features matrix](https://www.prisma.io/docs/orm/reference/database-features) for a complete list...
----
...
Native database functions[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/unsupported-database-features#native-database-functions "Direct link to Native database functions")
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### When to use a database-level function[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/unsupported-database-features#when-to-use-a-database-level-function "Direct link to When to use a database-level function")
...
### Enable PostgreSQL extensions for native database functions[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/unsupported-database-features#enable-postgresql-extensions-for-native-database-functions "Direct link to Enable PostgreSQL extensions for native database functions")
...
`generator client {  provider        = "prisma-client"  output          = "./generated"  previewFeatures = ["postgresqlExtensions"]}datasource db {  provider   = "postgresql"  extensions = [pgcrypto]}`

`In earlier versions of Prisma ORM, you must instead run a SQL command to activate the extension:```sqlCREATE EXTENSION IF NOT EXISTS pgcrypto;`
...
Unsupported field types[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/unsupported-database-features#unsupported-field-types "Direct link to Unsupported field types")
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Unsupported database features[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/unsupported-database-features#unsupported-database-features "Direct link to Unsupported database features")
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
