...
- Source page: /docs/orm/prisma-schema/data-model/models
- Keywords: prisma, prisma schema, orm, docs, docs, orm, prisma schema, data model, models
- Summary: The data model definition part of the [Prisma schema](https://www.prisma.io/docs/orm/prisma-schema) defines your application models (also called **Prisma models**). Models:
----
...
`datasource db {  provider = "postgresql"}generator client {  provider = "prisma-client"  output   = "./generated"}model User {  id      Int      @id @default(autoincrement())  email   String   @unique  name    String?  role    Role     @default(USER)  posts   Post[]  profile Profile?}model Profile {  id     Int    @id @default(autoincrement())  bio    String  user   User   @relation(fields: [userId], references: [id])  userId Int    @unique}model Post {  id         Int        @id @default(autoincrement())  createdAt  DateTime   @default(now())  updatedAt  DateTime   @updatedAt  title      String  published  Boolean    @default(false)  author     User       @relation(fields: [authorId], references: [id])  authorId   Int  categories Category[]}model Category {  id    Int    @id @default(autoincrement())  name  String  posts Post[]}enum Role {  USER  ADMIN}`

The data model definition is made up of:

*   [Models](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-models) ([`model`](https://www.prisma.io/docs/orm/reference/prisma-schema-reference#model) primitives) that define a number of fields, including [relations between models](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#relation-fields)
*   [Enums](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-enums) ([`enum`](https://www.prisma.io/docs/orm/reference/prisma-schema-reference#enum) primitives) (if your connector supports Enums)
*   [Attributes](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-attributes) and [functions](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#using-functions) that change the behavior of fields and models

The corresponding database looks like this:

![Image 1: Sample database](https://www.prisma.io/docs/assets/images/sample-database-e2456fd83e4d78b07c0c9206f70d9747.png)
...
Introspection and migration[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#introspection-and-migration "Direct link to Introspection and migration")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Defining models[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-models "Direct link to Defining models")
----------------------------------------------------------------------------------------------------------------------------------
...
### Mapping model names to tables or collections[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#mapping-model-names-to-tables-or-collections "Direct link to Mapping model names to tables or collections")
...
Defining fields[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-fields "Direct link to Defining fields")
----------------------------------------------------------------------------------------------------------------------------------
...
*   Optional **[type modifiers](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#type-modifiers)**
*   Optional **[attributes](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-attributes)**, including [native database type attributes](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#native-types-mapping)

A field's type determines its _structure_, and fits into one of two categories:

*   [Scalar types](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#scalar-fields) (includes [enums](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-enums)) that map to columns (relational databases) or document fields (MongoDB) in the database - for example, [`String`](https://www.prisma.io/docs/orm/reference/prisma-schema-reference#string) or [`Int`](https://www.prisma.io/docs/orm/reference/prisma-schema-reference#int)
...
### Scalar fields[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#scalar-fields "Direct link to Scalar fields")

The following example extends the `Comment` and `Tag` models with several scalar types. Some fields include [attributes](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-attributes):
...
### Relation fields[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#relation-fields "Direct link to Relation fields")
...
### Native types mapping[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#native-types-mapping "Direct link to Native types mapping")
...
#### Benefits and workflows[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#benefits-and-workflows "Direct link to Benefits and workflows")
...
### Type modifiers[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#type-modifiers "Direct link to Type modifiers")
...
#### Lists[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#lists "Direct link to Lists")
...
#### Optional and mandatory fields[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#optional-and-mandatory-fields "Direct link to Optional and mandatory fields")
...
*   **Prisma Client**: Prisma Client's generated [TypeScript types](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#type-definitions) that represent the models in your application code will also define these fields as required to ensure they always carry values at runtime.

> **Note**: The default value of an optional field is `null`.

### Unsupported types[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#unsupported-types "Direct link to Unsupported types")
...
Fields of type `Unsupported` do not appear in the generated Prisma Client API, but you can still use Prisma ORM’s [raw database access feature](https://www.prisma.io/docs/orm/prisma-client/using-raw-sql/raw-queries) to query these fields.
...
Defining attributes[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-attributes "Direct link to Defining attributes")
----------------------------------------------------------------------------------------------------------------------------------------------
...
### Defining an ID field[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-an-id-field "Direct link to Defining an ID field")
...
#### Defining IDs in relational databases[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-ids-in-relational-databases "Direct link to Defining IDs in relational databases")
...
##### Single field IDs[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#single-field-ids "Direct link to Single field IDs")
...
##### Composite IDs[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#composite-ids "Direct link to Composite IDs")
...
##### `@unique` fields as unique identifiers[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#unique-fields-as-unique-identifiers "Direct link to unique-fields-as-unique-identifiers")
...
#### Defining IDs in MongoDB[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-ids-in-mongodb "Direct link to Defining IDs in MongoDB")
...
### Defining a default value[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-a-default-value "Direct link to Defining a default value")
...
*   [Functions](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#using-functions), such as [`now()`](https://www.prisma.io/docs/orm/reference/prisma-schema-reference#now) or [`uuid()`](https://www.prisma.io/docs/orm/reference/prisma-schema-reference#uuid)
...
### Defining a unique field[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-a-unique-field "Direct link to Defining a unique field")
...
#### Composite type unique constraints[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#composite-type-unique-constraints "Direct link to Composite type unique constraints")

When using the MongoDB provider in version `3.12.0` and later, you can define a unique constraint on a field of a [composite type](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-composite-types) using the syntax `@@unique([compositeType.field])`. As with other fields, composite type fields can be used as part of a multi-column unique constraint.
...
### Defining an index[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-an-index "Direct link to Defining an index")
...
#### Defining composite type indexes[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-composite-type-indexes "Direct link to Defining composite type indexes")

When using the MongoDB provider in version `3.12.0` and later, you can define an index on a field of a [composite type](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-composite-types) using the syntax `@@index([compositeType.field])`. As with other fields, composite type fields can be used as part of a multi-column index.
...
Defining enums[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-enums "Direct link to Defining enums")
-------------------------------------------------------------------------------------------------------------------------------
...
Enums are considered [scalar](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#scalar-fields) types in the Prisma schema data model. They're therefore [by default](https://www.prisma.io/docs/orm/prisma-client/queries/select-fields#return-the-default-fields) included as return values in [Prisma Client queries](https://www.prisma.io/docs/orm/prisma-client/queries/crud).
...
Defining composite types[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-composite-types "Direct link to Defining composite types")
-------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Composite types (known as [embedded documents](https://www.mongodb.com/docs/manual/data-modeling/#embedded-data) in MongoDB) provide support for embedding records inside other records, by allowing you to define new object types. Composite types are structured and typed in a similar way to [models](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-models).
...
### Considerations when using composite types[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#considerations-when-using-composite-types "Direct link to Considerations when using composite types")
...
However, unique constraints can still be defined by using the `@@unique` attribute on the level of the model that uses the composite type. For more details, see [Composite type unique constraints](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#composite-type-unique-constraints).

Indexes can be defined by using the `@@index` attribute on the level of the model that uses the composite type. For more details, see [Composite type indexes](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#defining-composite-type-indexes).

Using functions[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#using-functions "Direct link to Using functions")
----------------------------------------------------------------------------------------------------------------------------------
...
Relations[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#relations "Direct link to Relations")
----------------------------------------------------------------------------------------------------------------

Refer to the [relations documentation](https://www.prisma.io/docs/orm/prisma-schema/data-model/relations) for more examples and information about relationships between models.

Models in Prisma Client[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#models-in-prisma-client "Direct link to Models in Prisma Client")
----------------------------------------------------------------------------------------------------------------------------------------------------------

### Queries (CRUD)[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#queries-crud "Direct link to Queries (CRUD)")
...
### Type definitions[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#type-definitions "Direct link to Type definitions")
...
Limitations[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#limitations "Direct link to Limitations")
----------------------------------------------------------------------------------------------------------------------

### Records must be uniquely identifiable[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/models#records-must-be-uniquely-identifiable "Direct link to Records must be uniquely identifiable")
