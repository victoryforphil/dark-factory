...
- Source page: /docs/orm/prisma-schema/data-model/relations/referential-actions/special-rules-for-referential-actions
- Keywords: prisma, prisma schema, orm, docs, docs, orm, prisma schema, data model, relations, referential actions, special rules for referential actions
- Summary: This page explains special rules and common issues when using referential actions with SQL Server and MongoDB, including how to avoid cycles and multiple cascade paths.
----

Source: https://www.prisma.io/docs/orm/prisma-schema/data-model/relations/referential-actions/special-rules-for-referential-actions
...
Self-relation (SQL Server and MongoDB)[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/referential-actions/special-rules-for-referential-actions#self-relation-sql-server-and-mongodb "Direct link to Self-relation (SQL Server and MongoDB)")
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Multiple cascade paths between two models (SQL Server only)[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/referential-actions/special-rules-for-referential-actions#multiple-cascade-paths-between-two-models-sql-server-only "Direct link to Multiple cascade paths between two models (SQL Server only)")
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
