...
- Source page: /docs/orm/prisma-schema/data-model/relations/relation-mode
- Keywords: prisma, prisma schema, orm, docs, docs, orm, prisma schema, data model, relations, relation mode
- Summary: Questions answered in this page
----
...
If you use Prisma ORM with a relational database, then by default Prisma ORM uses the [`foreignKeys` relation mode](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#handle-relations-in-your-relational-database-with-the-foreignkeys-relation-mode), which enforces relations between records at the database level with foreign keys. A foreign key is a column or group of columns in one table that take values based on the primary key in another table. Foreign keys allow you to:
...
How to set the relation mode in your Prisma schema[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#how-to-set-the-relation-mode-in-your-prisma-schema "Direct link to How to set the relation mode in your Prisma schema")
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
`datasource db {  provider     = "mysql"  relationMode = "prisma"}`
...
If you switch between relation modes, Prisma ORM will add or remove foreign keys to your database next time you apply changes to your schema with Prisma Migrate or `db push`. See [Switch between relation modes](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#switch-between-relation-modes) for more information.

Handle relations in your relational database with the `foreignKeys` relation mode[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#handle-relations-in-your-relational-database-with-the-foreignkeys-relation-mode "Direct link to handle-relations-in-your-relational-database-with-the-foreignkeys-relation-mode")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
The `foreignKeys` relation mode is not available when you use the MongoDB connector. Some relational databases, [such as PlanetScale](https://www.prisma.io/docs/orm/overview/databases/planetscale#option-1-emulate-relations-in-prisma-client), also forbid the use of foreign keys. In these cases, you should instead [emulate relations in Prisma ORM with the `prisma` relation mode](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#emulate-relations-in-prisma-orm-with-the-prisma-relation-mode).

### Referential integrity[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#referential-integrity "Direct link to Referential integrity")
...
#### Foreign key constraints[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#foreign-key-constraints "Direct link to Foreign key constraints")
...
#### Referential actions[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#referential-actions "Direct link to Referential actions")
...
### Introspection[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#introspection "Direct link to Introspection")
...
### Prisma Migrate and `db push`[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#prisma-migrate-and-db-push "Direct link to prisma-migrate-and-db-push")
...
Emulate relations in Prisma ORM with the `prisma` relation mode[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#emulate-relations-in-prisma-orm-with-the-prisma-relation-mode "Direct link to emulate-relations-in-prisma-orm-with-the-prisma-relation-mode")
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
### Which foreign key constraints are emulated?[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#which-foreign-key-constraints-are-emulated "Direct link to Which foreign key constraints are emulated?")
...
### Which referential actions are emulated?[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#which-referential-actions-are-emulated "Direct link to Which referential actions are emulated?")
...
### Error messages[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#error-messages "Direct link to Error messages")
...
### Introspection[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#introspection-1 "Direct link to Introspection")
...
### Prisma Migrate and `db push`[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#prisma-migrate-and-db-push-1 "Direct link to prisma-migrate-and-db-push-1")
...
### Indexes[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#indexes "Direct link to Indexes")
...
#### Index validation[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#index-validation "Direct link to Index validation")
...
`datasource db {  provider     = "mysql"  relationMode = "prisma"}model User {  id    Int    @id  posts Post[]}model Post {  id     Int  @id  userId Int  user   User @relation(fields: [userId], references: [id])}`
...
![Image 1: The Quick Fix pop-up for adding an index on a relation scalar field in VS Code](https://www.prisma.io/docs/assets/images/quick-fix-index-ab029114d21b44b322bfd77b6cac6e83.png)
...
### Switch from `foreignKeys` to `prisma`[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#switch-from-foreignkeys-to-prisma "Direct link to switch-from-foreignkeys-to-prisma")
...
### Switch from `prisma` to `foreignKeys`[​](http://www.prisma.io/docs/orm/prisma-schema/data-model/relations/relation-mode#switch-from-prisma-to-foreignkeys "Direct link to switch-from-prisma-to-foreignkeys")
