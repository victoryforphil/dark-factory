...
- Source page: /eden/treaty/config.md
- Keywords: elysiajs, docs, bun, typescript, eden, treaty, config md
- Summary: url: 'https://elysiajs.com/eden/treaty/config.md'
----
