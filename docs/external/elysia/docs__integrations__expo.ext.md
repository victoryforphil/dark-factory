...
- Source page: /integrations/expo.md
- Keywords: elysiajs, docs, bun, typescript, integrations, expo md
- Summary: url: 'https://elysiajs.com/integrations/expo.md'
----
...
export const api = treaty('localhost:3000/api')
```
