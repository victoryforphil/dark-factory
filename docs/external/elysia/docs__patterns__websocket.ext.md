...
- Source page: /patterns/websocket.md
- Keywords: elysiajs, docs, bun, typescript, patterns, websocket md
- Summary: url: 'https://elysiajs.com/patterns/websocket.md'
----
...
```typescript
.ws(endpoint: path, options: Partial>): this
```
