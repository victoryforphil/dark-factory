...
- Source page: /essential/plugin.md
- Keywords: elysiajs, docs, bun, typescript, essential, plugin md
- Summary: url: 'https://elysiajs.com/essential/plugin.md'
----
