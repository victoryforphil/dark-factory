...
- Source page: /patterns/typescript.md
- Keywords: elysiajs, docs, bun, typescript, patterns, typescript md
- Summary: url: 'https://elysiajs.com/patterns/typescript.md'
----
...
const api = treaty('localhost:3000') // [!code ++]
```
