...
- Source page: /patterns/configuration.md
- Keywords: elysiajs, docs, bun, typescript, patterns, configuration md
- Summary: url: 'https://elysiajs.com/patterns/configuration.md'
----
