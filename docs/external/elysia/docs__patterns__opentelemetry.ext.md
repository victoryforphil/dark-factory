...
- Source page: /patterns/opentelemetry.md
- Keywords: elysiajs, docs, bun, typescript, patterns, opentelemetry md
- Summary: url: 'https://elysiajs.com/patterns/opentelemetry.md'
----
...
As OpenTelemetry rely on monkey-patching `node_modules/`. It's required that make instrumentations works properly, we need to specify that libraries to be instrument is an external module to exclude it from being bundled.
