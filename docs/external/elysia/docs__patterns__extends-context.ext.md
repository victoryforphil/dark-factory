...
- Source page: /patterns/extends-context.md
- Keywords: elysiajs, docs, bun, typescript, patterns, extends context md
- Summary: url: 'https://elysiajs.com/patterns/extends-context.md'
----
