...
- Source page: /migrate/from-fastify.md
- Keywords: elysiajs, docs, bun, typescript, migrate, from fastify md
- Summary: url: 'https://elysiajs.com/migrate/from-fastify.md'
----
