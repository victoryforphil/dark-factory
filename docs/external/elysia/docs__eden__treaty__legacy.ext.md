...
- Source page: /eden/treaty/legacy.md
- Keywords: elysiajs, docs, bun, typescript, eden, treaty, legacy md
- Summary: url: 'https://elysiajs.com/eden/treaty/legacy.md'
----
