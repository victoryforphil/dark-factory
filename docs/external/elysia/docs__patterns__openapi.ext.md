...
- Source page: /patterns/openapi.md
- Keywords: elysiajs, docs, bun, typescript, patterns, openapi md
- Summary: url: 'https://elysiajs.com/patterns/openapi.md'
----
...
function getUser(): Prettify { // [!code ++]
