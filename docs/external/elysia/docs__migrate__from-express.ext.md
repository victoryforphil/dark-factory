...
- Source page: /migrate/from-express.md
- Keywords: elysiajs, docs, bun, typescript, migrate, from express md
- Summary: url: 'https://elysiajs.com/migrate/from-express.md'
----
