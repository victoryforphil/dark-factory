...
- Source page: /integrations/netlify.md
- Keywords: elysiajs, docs, bun, typescript, integrations, netlify md
- Summary: url: 'https://elysiajs.com/integrations/netlify.md'
----
...
Netlify Edge Functions requires a special directory to run a function, the default is **\/netlify/edge-functions**.
