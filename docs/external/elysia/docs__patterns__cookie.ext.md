...
- Source page: /patterns/cookie.md
- Keywords: elysiajs, docs, bun, typescript, patterns, cookie md
- Summary: url: 'https://elysiajs.com/patterns/cookie.md'
----
...
Since cookies are Proxy-dependent objects by default, the extract value can never be **undefined**; instead, it will always be a value of `Cookie`, which can be obtained by invoking the **.value** property.
